...
namespace SPMWebApp.LeadsContactManagementService {
    ...
    public partial class LeadsContactManagement : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataSet DeleteLeadsContact(string recId, string dealerCode, string UserID, string dbConnectionStr) {
        ...
        /// <remarks/>
        public void DeleteLeadsContactAsync(string recId, string dealerCode, string UserID, string dbConnectionStr) {
            this.DeleteLeadsContactAsync(recId, dealerCode, UserID, dbConnectionStr, null);
        }
        
        /// <remarks/>
        public void DeleteLeadsContactAsync(string recId, string dealerCode, string UserID, string dbConnectionStr, object userState) {
        ...
        public System.Data.DataSet PrepareForLeadsAnalysis(string UserID, string dbConnectionStr) {
        ...
        /// <remarks/>
        public void PrepareForLeadsAnalysisAsync(string UserID, string dbConnectionStr) {
            this.PrepareForLeadsAnalysisAsync(UserID, dbConnectionStr, null);
        }
        
        /// <remarks/>
        public void PrepareForLeadsAnalysisAsync(string UserID, string dbConnectionStr, object userState) {
