...
namespace SPMWebApp.SPMSetupService {
    ...
    public partial class SPMSetup : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback DeleteDealerByUserIdOperationCompleted;
        
        private System.Threading.SendOrPostCallback InsertDealerOperationCompleted;
        
        private System.Threading.SendOrPostCallback CheckDealerExistsOperationCompleted;
        ...
        /// <remarks/>
        public event DeleteDealerByUserIdCompletedEventHandler DeleteDealerByUserIdCompleted;
        
        /// <remarks/>
        public event InsertDealerCompletedEventHandler InsertDealerCompleted;
        
        /// <remarks/>
        public event CheckDealerExistsCompletedEventHandler CheckDealerExistsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/DeleteDealerByUserId", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string[] DeleteDealerByUserId(string userId, string dbConnStr) {
            object[] results = this.Invoke("DeleteDealerByUserId", new object[] {
                        userId,
                        dbConnStr});
            return ((string[])(results[0]));
        }
        ...
        /// <remarks/>
        public void DeleteDealerByUserIdAsync(string userId, string dbConnStr) {
            this.DeleteDealerByUserIdAsync(userId, dbConnStr, null);
        }
        
        /// <remarks/>
        public void DeleteDealerByUserIdAsync(string userId, string dbConnStr, object userState) {
            if ((this.DeleteDealerByUserIdOperationCompleted == null)) {
                this.DeleteDealerByUserIdOperationCompleted = new System.Threading.SendOrPostCallback(this.OnDeleteDealerByUserIdOperationCompleted);
            }
            this.InvokeAsync("DeleteDealerByUserId", new object[] {
                        userId,
                        dbConnStr}, this.DeleteDealerByUserIdOperationCompleted, userState);
        }
        
        private void OnDeleteDealerByUserIdOperationCompleted(object arg) {
            if ((this.DeleteDealerByUserIdCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DeleteDealerByUserIdCompleted(this, new DeleteDealerByUserIdCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/CheckDealerExists", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string[] CheckDealerExists(string userid, string dbConnectionStr) {
            object[] results = this.Invoke("CheckDealerExists", new object[] {
                        userid,
                        dbConnectionStr});
            return ((string[])(results[0]));
        }
        ...
        /// <remarks/>
        public void CheckDealerExistsAsync(string userid, string dbConnectionStr) {
            this.CheckDealerExistsAsync(userid, dbConnectionStr, null);
        }
        
        /// <remarks/>
        public void CheckDealerExistsAsync(string userid, string dbConnectionStr, object userState) {
            if ((this.CheckDealerExistsOperationCompleted == null)) {
                this.CheckDealerExistsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnCheckDealerExistsOperationCompleted);
            }
            this.InvokeAsync("CheckDealerExists", new object[] {
                        userid,
                        dbConnectionStr}, this.CheckDealerExistsOperationCompleted, userState);
        }
        
        private void OnCheckDealerExistsOperationCompleted(object arg) {
            if ((this.CheckDealerExistsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.CheckDealerExistsCompleted(this, new CheckDealerExistsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    public delegate void DeleteDealerByUserIdCompletedEventHandler(object sender, DeleteDealerByUserIdCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DeleteDealerByUserIdCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DeleteDealerByUserIdCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    public delegate void CheckDealerExistsCompletedEventHandler(object sender, CheckDealerExistsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class CheckDealerExistsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal CheckDealerExistsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
