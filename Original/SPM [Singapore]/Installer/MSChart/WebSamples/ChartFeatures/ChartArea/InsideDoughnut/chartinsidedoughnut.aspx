			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:chart id="Chart1" runat="server" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BorderDashStyle="Solid" Palette="BrightPastel" IsSoftShadows="False" BackGradientStyle="TopBottom" BorderWidth="2" BackColor="#F3DFC1" BorderColor="181, 64, 1" Height="296px">
							<legends>
