	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Height="296px" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" Palette="BrightPastel" BorderColor="26, 59, 105" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#D3DFF0">
							<legends>
