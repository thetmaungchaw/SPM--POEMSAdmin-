	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><!-- CHART HERE (412x296 px)--><asp:chart id="Chart1" runat="server" Height="296px" Width="412px" BackColor="#F3DFC1" Palette="BrightPastel" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="181, 64, 1" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<legends>
