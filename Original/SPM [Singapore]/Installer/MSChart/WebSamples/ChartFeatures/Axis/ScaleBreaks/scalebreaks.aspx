	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Width="412px" Height="296px" BorderDashStyle="Solid" palette="BrightPastel" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#D3DFF0" BorderColor="26, 59, 105" BackSecondaryColor="White" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<legends>
