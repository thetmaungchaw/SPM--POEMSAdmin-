	...
	<body>
		<form method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" BackColor="#F3DFC1" ImageType="Png" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" Width="412px" Height="296px" BackGradientStyle="TopBottom" Palette="BrightPastel" BorderDashStyle="Solid" BorderColor="181, 64, 1" BorderWidth="2">
<legends>
