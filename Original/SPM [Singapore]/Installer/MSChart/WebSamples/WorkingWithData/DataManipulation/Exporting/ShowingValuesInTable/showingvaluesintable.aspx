			...
			<table id="Table1" cellSpacing="7" cellpadding="1" border="0">
				<tr>
					<td valign="top" align="left">
						<asp:chart id="Chart1" runat="server" Palette="BrightPastel" ImageType="Png" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" Width="600px" Height="200px" BorderDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="WhiteSmoke" BorderColor="26, 59, 105">
							<legends>
