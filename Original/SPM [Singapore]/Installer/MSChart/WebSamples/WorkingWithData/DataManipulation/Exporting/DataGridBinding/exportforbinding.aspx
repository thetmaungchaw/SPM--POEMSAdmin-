	...
	<body>
		<form method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Palette="BrightPastel" BackColor="#D3DFF0" Width="412px" Height="296px" BackGradientStyle="TopBottom" BorderColor="26, 59, 105" BorderDashStyle="Solid" BorderWidth="2" imagetype="Png" ImageLocation="~\TempImages\ChartPic_#SEQ(300,3)">
							<titles>
