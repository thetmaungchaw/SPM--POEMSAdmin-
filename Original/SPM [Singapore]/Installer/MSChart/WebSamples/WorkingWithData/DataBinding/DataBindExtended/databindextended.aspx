	...
	<body>
		<form id="ImageMapCustom" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Width="412px" Height="296px" BorderColor="26, 59, 105" TextAntiAliasingQuality="Normal" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BackSecondaryColor="White" palette="BrightPastel" BorderWidth="2" backcolor="WhiteSmoke" imagetype="Png" ImageLocation="~\TempImages\ChartPic_#SEQ(300,3)">
							<titles>
