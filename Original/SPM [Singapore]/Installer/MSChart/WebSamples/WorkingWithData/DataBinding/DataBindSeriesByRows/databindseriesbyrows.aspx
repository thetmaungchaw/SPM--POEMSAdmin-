	...
	<body>
		<form id="ImageMapCustom" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" BackColor="WhiteSmoke" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderDashStyle="Solid" Palette="BrightPastel" BorderColor="26, 59, 105" Height="296px" Width="412px" BorderWidth="2" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<legends>
