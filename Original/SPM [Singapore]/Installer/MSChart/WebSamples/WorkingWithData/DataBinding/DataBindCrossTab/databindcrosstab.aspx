	...
	<body>
		<form id="ImageMapCustom" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Width="412px" Height="296px" BorderColor="181, 64, 1" Palette="BrightPastel" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#F3DFC1" imagetype="Png" ImageLocation="~\TempImages\ChartPic_#SEQ(300,3)">
							<legends>
