			...
			<table class="sampleTable">
				<tr>
					<td width="460" class="tdchart">
						<asp:chart id="Chart1" runat="server" Height="296px" Width="460px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BackColor="WhiteSmoke" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderColor="26, 59, 105" Palette="BrightPastel" BorderDashStyle="Solid" BorderWidth="2">
							<titles>
