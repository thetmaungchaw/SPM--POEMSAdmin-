			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" BackColor="WhiteSmoke" Width="412px" Height="296px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" Palette="BrightPastel" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderDashStyle="Solid" BorderWidth="2" BorderColor="26, 59, 105">
							<titles>
