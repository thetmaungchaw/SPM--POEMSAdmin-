			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" BackColor="#F3DFC1" Width="412px" Height="296px" BorderDashStyle="Solid" Palette="BrightPastel" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="181, 64, 1" ImageType="Png" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<titles>
