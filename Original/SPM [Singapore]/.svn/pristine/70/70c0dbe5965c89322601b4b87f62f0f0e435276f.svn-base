						...
						<table class="controls" cellpadding="4">
							...
							<tr>
								<td colspan="2">
									...
									<asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxY" ErrorMessage="Y Value Cannot be Empty" cssclass="validator"></asp:requiredfieldvalidator></td>
					</td>
				</tr>
			</table>
