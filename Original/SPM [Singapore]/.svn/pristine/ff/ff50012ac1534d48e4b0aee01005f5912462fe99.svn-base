			...
			<table class="sampleTable">
				<tr>
					<td width="460" class="tdchart">
						<asp:chart id="Chart1" runat="server" BackColor="#D3DFF0" Width="460px" Height="330px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BorderDashStyle="Solid" Palette="BrightPastel" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105" enableviewstate="True" viewstatecontent="All">
							<legends>
