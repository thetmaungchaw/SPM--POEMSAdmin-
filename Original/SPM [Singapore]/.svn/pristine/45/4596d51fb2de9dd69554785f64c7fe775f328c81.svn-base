			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:chart id="Chart1" runat="server" BorderColor="26, 59, 105" Palette="BrightPastel" BackColor="#D3DFF0" Width="412px" Height="296px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" BorderDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" ImageType="Png">
							<legends>
