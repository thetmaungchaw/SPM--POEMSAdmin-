			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Width="412px" Height="296px" Palette="BrightPastel" BackColor="#D3DFF0" BorderColor="26, 59, 105" BorderWidth="2" BorderDashStyle="Solid" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" BackSecondaryColor="White" BackGradientStyle="TopBottom" ImageType="Png">
							<titles>
