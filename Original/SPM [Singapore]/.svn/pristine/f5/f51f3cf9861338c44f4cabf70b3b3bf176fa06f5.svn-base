	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><!-- CHART HERE--><asp:chart id="Chart1" runat="server" Height="306px" Width="412px" BorderDashStyle="Solid" palette="Pastel" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#D3DFF0" BorderColor="26, 59, 105" imagetype="Png" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<titles>
