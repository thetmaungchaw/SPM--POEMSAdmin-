...
&nbsp;&nbsp;&nbsp;
		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart">
						<asp:chart id="Chart1" runat="server" Width="412px" BackGradientStyle="TopBottom" BackSecondaryColor="White" Palette="BrightPastel" BorderColor="26, 59, 105" BackColor="#D3DFF0" Height="296px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" BorderDashStyle="Solid" BorderWidth="2" imagetype="Png">
<legends>
