	...
	<body>
		<form method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" Height="296px" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BackColor="#F3DFC1" BorderDashStyle="Solid" BackGradientStyle="TopBottom" Palette="BrightPastel" BorderColor="181, 64, 1" BorderWidth="2">
							<legends>
