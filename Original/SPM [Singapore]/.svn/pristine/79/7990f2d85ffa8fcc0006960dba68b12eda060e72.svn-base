			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Height="296px" Width="412px" BackColor="WhiteSmoke" BorderColor="26, 59, 105" BorderDashStyle="Solid" Palette="BrightPastel" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" TextAntiAliasingQuality="Normal" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
							<legends>
