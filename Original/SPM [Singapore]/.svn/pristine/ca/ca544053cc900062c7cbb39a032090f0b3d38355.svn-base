			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart" valign="top">
						<asp:chart id="Chart1" runat="server" Height="296px" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BorderDashStyle="Solid" Palette="Pastel" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" BackColor="#D3DFF0" BorderColor="26, 59, 105">
							<titles>
