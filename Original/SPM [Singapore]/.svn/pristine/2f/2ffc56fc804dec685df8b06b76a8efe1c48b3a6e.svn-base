	...
	<body>
		<form id="LegendCustomPosition" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart" width="412"><asp:CHART id="Chart1" runat="server" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" BackColor="#D3DFF0" Palette="BrightPastel" BackGradientStyle="TopBottom" BorderColor="26, 59, 105" BorderDashStyle="Solid" Height="296px" Width="412px" BorderWidth="2" ImageType="Png">
							<legends>
