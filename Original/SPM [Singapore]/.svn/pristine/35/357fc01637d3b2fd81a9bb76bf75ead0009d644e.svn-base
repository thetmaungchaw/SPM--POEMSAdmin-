	...
	<body>
		<form method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" BorderColor="26, 59, 105" BorderWidth="2" BackGradientStyle="TopBottom" palette="BrightPastel" BorderDashStyle="Solid" BackColor="#D3DFF0" Height="296px" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png">
							<legends>
