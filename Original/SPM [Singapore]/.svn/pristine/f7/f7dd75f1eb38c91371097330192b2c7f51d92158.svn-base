			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Width="412px" Height="296px" BorderDashStyle="Solid" BorderColor="26, 59, 105" BackGradientStyle="TopBottom" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" Palette="BrightPastel" BorderWidth="2" BackColor="#D3DFF0">
							<legends>
