			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Width="412px" Height="296px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BorderColor="181, 64, 1" BackColor="#F3DFC1" Palette="BrightPastel" BackGradientStyle="TopBottom" BorderDashStyle="Solid" BorderWidth="2">
							<titles>
