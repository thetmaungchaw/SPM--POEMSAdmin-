			...
			<table class="sampleTable" id=Table1>
				<tr>
					<td width="460" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Height="330px" Width="460px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BackColor="#D3DFF0" BorderDashStyle="Solid" Palette="BrightPastel" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105">
							<titles>
